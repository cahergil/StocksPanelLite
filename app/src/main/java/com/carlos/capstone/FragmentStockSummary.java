...
public class FragmentStockSummary extends Fragment implements View.OnClickListener, OnChartGestureListener,LoaderManager.LoaderCallbacks<Cursor>{
  ...
  //  private android.widget.ShareActionProvider shareActionProvider;
    ...
    private @ChartMode int mChartMode;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if(getActivity() instanceof DetailStockActivity) {
            ...
            sendIntent.setType("text/plain");//dummy intent
            ...
            //check out wheather the security is already in favorite
    ...
    private @ChartMode int getmChartModeParcelable(Bundle b) {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        //outState.putParcelableArray("highlight",mChart.getHighlighted());
    ...
    private void shareElement(){
        File file=new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES),"share_pic.jpg");
        ...
        try {
            ...
            Log.d(LOG_TAG,"error creating share file from bitmap");
        }
...
//            String imageString = cursor.getString(idx);
...
//        }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        if( data!=null &&  !data.moveToFirst()) {
            ...
            if(!Utilities.isNetworkAvailable(getActivity())){
                Snackbar.make(mScrollView, getString(R.string.no_internet_conextion),Snackbar.LENGTH_LONG).show();
            }
            return;
        }
