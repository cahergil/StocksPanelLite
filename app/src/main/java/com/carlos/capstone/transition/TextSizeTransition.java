...
public class TextSizeTransition extends Transition {
    ...
    private static final Property<TextView, Float> TEXT_SIZE_PROPERTY =createProperty();

    @TargetApi(14)
    private static Property<TextView, Float> createProperty() {

       return new Property<TextView, Float>(Float.class, "textSize") {
            @Override
